...
(function () {
  ...
  var codingDomains = {
    tech: {
      ...
      value: "Con chọn 1 trong 3 hướng chuyên sâu: Full Stack Web, Data Analysis, hoặc UI/UX Design — tất cả đều tích hợp AI thực chiến.\n\n✦ Sau 12 tháng, con có portfolio chuyên nghiệp đủ sức ứng tuyển vị trí Junior tại các công ty tech\n✦ Con được mentor 1-1 bởi chuyên gia đang làm trong ngành — không phải giáo viên kiêm nhiệm\n✦ Kỹ năng thật, dự án thật, công cụ thật: React, Python, Figma, Power BI — đúng stack mà doanh nghiệp đang cần\n\n🎯 Vị trí đầu ra: Junior Web Developer, Data Analyst, UI/UX Designer — lương khởi điểm 12–20 triệu/tháng tại VN",
    ...
    marketing: {
      ...
      value: "Con làm chủ Digital Marketing đa kênh — từ quảng cáo, SEO đến sáng tạo nội dung, tất cả với AI hỗ trợ.\n\n✦ Con triển khai được chiến dịch thật từ A–Z: nghiên cứu thị trường → lên kế hoạch → chạy ads → đo lường ROI\n✦ AI4MKT giúp con tạo nội dung nhanh gấp 5 lần — lợi thế cạnh tranh so với marketer truyền thống\n✦ Con có portfolio chiến dịch thật — không phải bài tập lý thuyết\n\n🎯 Vị trí đầu ra: Digital Marketing Specialist, Content Creator, Growth Marketer — mức lương 10–25 triệu/tháng",
    ...
    finance: {
      ...
      value: "Con phân tích dữ liệu tài chính và ra quyết định dựa trên data — kỹ năng mà mọi tập đoàn đều cần.\n\n✦ Con xây dashboard tài chính bằng Power BI — trình bày cho ban lãnh đạo xem và ra quyết định\n✦ AI4Finance giúp con dùng Machine Learning dự báo xu hướng — bước đi trước của Financial Analyst hiện đại\n✦ Con hiểu quy trình nghiệp vụ doanh nghiệp (BPMN) — sẵn sàng cho cả hướng Finance lẫn IT Business Analyst\n\n🎯 Vị trí đầu ra: Financial Analyst, Business Analyst, Data Analyst — lương 12–30 triệu/tháng tại các tập đoàn",
    ...
    business: {
      ...
      value: "Con vận hành và tối ưu hóa quy trình doanh nghiệp — vai trò cầu nối giữa business và technology.\n\n✦ Con thiết kế được quy trình Agile/Scrum cho đội nhóm — kỹ năng Project Manager cấp junior\n✦ AI4B&O giúp con tự động hóa báo cáo, dashboard, workflow — giảm 60% thời gian thủ công\n✦ Con phân tích được yêu cầu nghiệp vụ → đặc tả → triển khai — từ ý tưởng đến sản phẩm\n\n🎯 Vị trí đầu ra: Business Analyst, Operations Manager, Project Manager — lương 12–35 triệu/tháng",
  ...
  var artNam7 = { id: "art_nam7", name: "Interaction Design \u2014 UX/UI", year: "N\u0103m 7", age: "15\u201318",
    value: "Con thiết kế app và website như Product Designer thật sự — không phải chỉ vẽ đẹp, mà giải quyết vấn đề của người dùng.\n\n4 học kỳ chuyên sâu với Figma — công cụ #1 của ngành thiết kế sản phẩm toàn cầu:\n✦ HK1: UI Design Foundation — làm chủ Figma, layout, typography, component\n✦ HK2: UX Research — phỏng vấn người dùng, persona, customer journey\n✦ HK3: Product Thinking — tư duy sản phẩm: người dùng + kinh doanh + công nghệ\n✦ HK4: Career Kickstart — real brief từ doanh nghiệp, hoàn thiện CV & portfolio\n\n🎨 Sản phẩm: Case study 15–20 screens + portfolio chuyên nghiệp\n\nSẵn sàng cho vị trí UI/UX Designer Intern — Fresher. Lương khởi điểm 10–18 triệu/tháng tại VN.",
  ...
  var specialPrograms = {
    coding: [
      { id: "sp_coding_ai4l", icon: "🤖", name: "AI4Learn", desc: "Con dùng AI để HỌC TỐT HƠN trên trường — không phải chỉ biết dùng AI.", color: "#111827",
        detail: "Khóa đệm chiến lược — 1 level × 6 buổi theo độ tuổi:\n\nDưới lớp 7 → Level 1: Sáng tạo nội dung với AI (tạo hình, slide, video)\nTrên lớp 7 → Level 2: Xây chatbot ôn bài + Study Pack cá nhân\n\nCon hình thành năng lực sử dụng AI đúng cách và có trách nhiệm — lợi thế mà trường phổ thông chưa dạy.\n\nKhông bán lẻ — nằm trong gói lộ trình 24 tháng trở lên" },
      { id: "sp_coding_nextgen", icon: "🚀", name: "NextGen", desc: "Con khởi nghiệp giả lập & gọi vốn trước 'Shark Tank'. 14 buổi × 3 lần.", color: "#E31F26",
        detail: "Con không chỉ code — con xây DOANH NGHIỆP từ sản phẩm code:\n\nGhép nhóm → xây sản phẩm thật → Go Live lên internet\nPhân tích thị trường (5 Forces & SWOT) → mô hình kinh doanh → định giá dự án\nSản xuất bản thuyết trình gọi vốn chuyên nghiệp\nThuyết trình trước hội đồng giả lập Shark Tank — có PH tham gia đánh giá\n\nĐây là trải nghiệm CEO ở tuổi teen — kỹ năng không trường học nào dạy." },
      { id: "sp_coding_intern1", icon: "💼", name: "Internship 1", desc: "Con thực tập 60h tại MindX — xây dự án tech thật với AI.", color: "#2563EB",
        detail: "60h thực tập tại phòng ban thực tế của MindX — con làm dự án thật, không phải bài tập:\n\nModun 1 (20h): Học chuyên môn nghiệp vụ + kiểm tra lý thuyết\nModun 2 (20h): Nghiệp vụ nâng cao + AI hỗ trợ học tập & thực tập\nModun 3 (20h): Xây dựng giải pháp nâng cao hiệu suất cho bộ phận\n\nVD: Chatbot AI nội bộ, trang web quản lý, hệ thống báo cáo tự động\nCon có kinh nghiệm thực tế + reference letter — lợi thế lớn trong hồ sơ." },
      { id: "sp_coding_intern2", icon: "📋", name: "Internship 2", desc: "Con quản lý dự án tech 60h — từ thực thi lên dẫn dắt.", color: "#059669",
        detail: "Nâng cấp từ Intern 1: con không chỉ CODE — con DẪN DẮT dự án:\n\nQuản lý dự án công nghệ với Agile/Scrum\nỨng dụng AI Core vào quy trình quản lý & ra quyết định\nLập kế hoạch, phân công, theo dõi tiến độ dự án thực tế\nPhối hợp đa phòng ban — kỹ năng Leadership & Teamwork\n\nTừ Thực thi → Quản lý → Chiến lược — lộ trình của mọi Tech Lead tương lai." },
      { id: "sp_coding_internx", icon: "🏆", name: "Internship X", desc: "Con thực tập tại DN đối tác — cam kết giới thiệu việc làm.", color: "#7C3AED",
        detail: "Thực tập chuyên môn 30h tại doanh nghiệp đối tác MindX:\n\nLàm việc trong môi trường doanh nghiệp thật — không phải mô phỏng\nMentor hướng dẫn 1-1 suốt quá trình\nPortfolio chuyên nghiệp — chứng minh năng lực bằng dự án thật\nCam kết giới thiệu việc làm sau hoàn thành (Job Guarantee)\n\nĐây là bước cuối cùng trước khi con bước vào thị trường lao động." }
    ],
    art: [
      { id: "sp_art_ai4l", icon: "🤖", name: "AI4Learn", desc: "Con dùng AI để học tốt hơn trên trường — và sáng tạo nội dung số.", color: "#111827",
        detail: "Khóa đệm chiến lược — 1 level × 6 buổi theo độ tuổi:\n\nTrong lộ trình Art: trước Character & Mascot → Level 1, sau → Level 2\nLevel 1: Sáng tạo nội dung với AI (tạo hình, slide, video bằng công cụ AI)\nLevel 2: Xây chatbot ôn bài + Study Pack cá nhân\n\nCon hình thành năng lực sử dụng AI đúng cách — lợi thế mà trường phổ thông chưa dạy.\nKhông bán lẻ — nằm trong gói 24 tháng trở lên" },
      { id: "sp_art_cregen", icon: "🎨", name: "CreGen", desc: "Con làm họa sĩ minh họa + triển lãm + gọi vốn.", color: "#8B5CF6",
        detail: "Con không chỉ vẽ — con làm dự án sáng tạo thật và TRÌNH BÀY trước công chúng:\n\nCreative Thinking Workshop: 4 buổi tư duy sáng tạo có cấu trúc\nKhóa Họa sĩ minh họa: đồ án lớn 14 buổi — con tự chọn đề tài, GV định hướng nghề\nSản phẩm: Truyện tranh hoàn chỉnh + ấn phẩm tuyên truyền\nTriển lãm sản phẩm và gọi vốn trước hội đồng — có PH tham gia\n\nCon học cách biến đam mê thành dự án có giá trị." },
      { id: "sp_art_intern1", icon: "💼", name: "Intern 1", desc: "Con thực tập trong studio sáng tạo — hiểu pipeline thật.", color: "#2563EB",
        detail: "Con hiểu cách một đội sáng tạo cùng làm ra sản phẩm hoàn chỉnh:\n\n4 vai trò thực tế: Project Coordinator, Visual Designer, Content Builder, Reviewer/QA\nCon luân phiên tất cả vai trò — hiểu toàn bộ pipeline sáng tạo\nLàm việc nhóm, phân vai, giao tiếp & phản biện chuyên nghiệp\n\nSản phẩm: Bộ poster cho sự kiện + Mini brand cho CLB giả định\nĐây không phải bài tập — đây là cách studio thật hoạt động." },
      { id: "sp_art_intern2", icon: "📋", name: "Intern 2", desc: "Con dẫn dắt dự án sáng tạo — từ thực thi lên PM.", color: "#E31F26",
        detail: "Nâng cấp từ Intern 1: con không chỉ làm — con DẪN DẮT dự án:\n\nLập kế hoạch, chia việc, theo dõi tiến độ, tổng hợp kết quả\n4 vai trò nâng cao: Creative PM, Visual Designer, Content Builder, Reviewer/QA\nSản phẩm: Project Plan + Project Report + Reflection cá nhân\n\nKhông phải ai cũng làm designer — nhưng ai cũng cần hiểu quản lý dự án." },
      { id: "sp_art_internx", icon: "🏆", name: "Internship X", desc: "Con thực tập tại studio/agency — cam kết việc làm.", color: "#7C3AED",
        detail: "Thực tập chuyên môn tại studio/agency đối tác MindX:\n\nLàm việc thực tế trong môi trường chuyên nghiệp\nMentor là designer chuyên nghiệp hướng dẫn trực tiếp\nPortfolio chuyên nghiệp — chứng minh năng lực bằng dự án thật\nCam kết giới thiệu việc làm: Graphic, Motion, UI/UX, Product Designer\n\nĐây là bước cuối cùng trước khi con bước vào ngành sáng tạo chuyên nghiệp." }
    ]
  };
  ...
  function renderCodingRoadmap() {
    ...
    var bfCard = el("div", { className: "tree-card", onClick: function() {
      showGenericDrawer("Business Foundation", "Con hi\u1EC3u c\u00E1ch doanh nghi\u1EC7p v\u1EADn h\u00E0nh \u2014 d\u00F9 con l\u00E0m ng\u00E0nh g\u00EC, \u0111\u00E2y l\u00E0 n\u1EC1n t\u1EA3ng th\u0103ng ti\u1EBFn nhanh h\u01A1n.\n\nLv1: MKT & Communication (14 bu\u1ED5i)\n\u2726 Ti\u1EBFp th\u1ECB, truy\u1EC1n th\u00F4ng th\u01B0\u01A1ng hi\u1EC7u, vi\u1EBFt content \u2014 k\u1EF9 n\u0103ng m\u1ECDi ng\u00E0nh \u0111\u1EC1u c\u1EA7n\n\nLv2: Sale & Operation (14 bu\u1ED5i)\n\u2726 B\u00E1n h\u00E0ng, v\u1EADn h\u00E0nh, CSKH \u2014 hi\u1EC3u doanh nghi\u1EC7p t\u1EEB b\u00EAn trong\n\nLv3: Finance & Accounting (14 bu\u1ED5i)\n\u2726 T\u00E0i ch\u00EDnh, k\u1EBF to\u00E1n, \u0111\u1ECDc b\u00E1o c\u00E1o \u2014 ng\u00F4n ng\u1EEF c\u1EE7a m\u1ECDi CEO\n\nCon \u0111\u01B0\u1EE3c TH\u1EEC 3 m\u1EA3ng kinh doanh tr\u01B0\u1EDBc khi ch\u1ECDn \u2014 gi\u1EA3m r\u1EE7i ro ch\u1ECDn sai ng\u00E0nh.",
        "Con hiểu cách doanh nghiệp vận hành từ bên trong — MKT, Sales, Finance.\n\n\u2726 3 levels × 14 buổi: con được THỬ làm marketing, bán hàng, quản lý tài chính\n\u2726 Dù con làm ngành gì, hiểu cách DN vận hành = thăng tiến nhanh hơn\n\u2726 Con chọn hướng sau khi đã trải nghiệm cả 3 mảng — giảm rủi ro chọn sai\n\nNền tảng cho cả khởi nghiệp lẫn làm việc tại tập đoàn.", "code_bf");
    }});
    ...
    var intCard = el("div", { className: "tree-card", onClick: function() {
      showGenericDrawer("Internship X \u2014 Career Kickstart", "Th\u1EF1c t\u1EADp chuy\u00EAn m\u00F4n t\u1EA1i doanh nghi\u1EC7p \u0111\u1ED1i t\u00E1c MindX\n\n\u2022 Th\u1EDDi l\u01B0\u1EE3ng: 30h th\u1EF1c t\u1EADp th\u1EF1c t\u1EBF\n\u2022 L\u00E0m vi\u1EC7c theo nh\u00F3m, qu\u1EA3n l\u00FD d\u1EF1 \u00E1n th\u1EF1c t\u1EBF\n\u2022 Mentor h\u01B0\u1EDBng d\u1EABn 1-1 su\u1ED1t qu\u00E1 tr\u00ECnh\n\u2022 Cam k\u1EBFt gi\u1EDBi thi\u1EC7u vi\u1EC7c l\u00E0m sau ho\u00E0n th\u00E0nh (Job Guarantee)\n\nS\u1EA3n ph\u1EA9m \u0111\u1EA7u ra: D\u1EF1 \u00E1n c\u00F4ng ngh\u1EC7 th\u1EF1c t\u1EBF \u0111\u01B0\u1EE3c doanh nghi\u1EC7p \u0111\u00E1nh gi\u00E1",
        "Con thực tập 30h tại doanh nghiệp đối tác MindX — làm việc THẬT.\n\n\u2726 Mentor hướng dẫn 1-1 suốt quá trình\n\u2726 Portfolio chuyên nghiệp — chứng minh năng lực bằng dự án doanh nghiệp thật\n\u2726 Cam kết giới thiệu việc làm sau hoàn thành (Job Guarantee)\n\nĐây là bước cuối cùng trước khi con bước vào thị trường lao động.", "code_internship");
    }});
    ...
    var dhCard = el("div", { className: "tree-card pink", onClick: function() {
      showGenericDrawer("X-Global Tech Seed", "Ch\u01B0\u01A1ng tr\u00ECnh \u01B0\u01A1m t\u1EA1o danh m\u1EE5c \u0111\u1EA7u t\u01B0 (Portfolio) & h\u1ED3 s\u01A1 n\u0103ng l\u1EF1c c\u00F4ng ngh\u1EC7 \u0111\u1ED9c quy\u1EC1n t\u1EA1i VN\n\n\u2022 Chuy\u1EC3n h\u00F3a d\u1EF1 \u00E1n c\u00E1 nh\u00E2n th\u00E0nh s\u1EA3n ph\u1EA9m th\u1EF1c t\u1EBF c\u00F3 s\u1EE9c \u1EA3nh h\u01B0\u1EDFng\n\u2022 \u1EE8ng d\u1EE5ng AI Agent l\u00E0m \u0111\u00F2n b\u1EA9y hi\u1EC7u su\u1EA5t\n\u2022 3 ng\u00E1ch: L\u1EADp tr\u00ECnh (Web), D\u1EEF li\u1EC7u (DA), Thi\u1EBFt k\u1EBF (UI/UX)\n\u2022 4 Phase: Product Foundation \u2192 Core Dev \u2192 Global Portfolio \u2192 Demo Day\n\u2022 Th\u1EF1c t\u1EADp chuy\u00EAn m\u00F4n 15 bu\u1ED5i t\u1EA1i ph\u00F2ng ban MindX\n\u2022 Letter of Recommendation + B\u1EA3ng \u0111i\u1EC3m k\u1EF9 thu\u1EADt + Gi\u1EA5y ch\u1EE9ng nh\u1EADn s\u1EF1 ki\u1EC7n\n\n\u0110\u1ED1i t\u01B0\u1EE3ng: HS THPT (l\u1EDBp 11-12) \u0111\u00E3 ho\u00E0n th\u00E0nh n\u1EC1n t\u1EA3ng, ho\u1EB7c Sinh vi\u00EAn",
        "Con x\u00E2y h\u1ED3 s\u01A1 du h\u1ECDc KH\u00C1C BI\u1EC6T \u2014 b\u1EB1ng s\u1EA3n ph\u1EA9m c\u00F4ng ngh\u1EC7 th\u1EF1c t\u1EBF, kh\u00F4ng ph\u1EA3i gi\u1EA5y t\u1EDD.\n\n\u2726 Portfolio Web/Data/UI-UX tr\u00EAn GitHub v\u00E0 Figma \u2014 th\u1EE9 h\u1ED9i \u0111\u1ED3ng tuy\u1EC3n sinh \u0111ang t\u00ECm\n\u2726 Capstone Hackathon: con v\u1EEBa thi v\u1EEBa t\u1ED5 ch\u1EE9c \u2014 ch\u1EE9ng minh leadership th\u1EF1c t\u1EBF\n\u2726 B\u1ED9 h\u1ED3 s\u01A1 \u0111\u1EA7y \u0111\u1EE7: Portfolio + LOR + Personal Statement + Tech Transcript\n\n\u0110\u1EA7u t\u01B0 1 \u0111\u01B0\u1EE3c 2: n\u0103ng l\u1EF1c Code/Data/Design + Storytelling cho du h\u1ECDc.", "code_duhoc");
    }});
  ...
  function renderArtRoadmap() {
    ...
    var artIntCard = el("div", { className: "tree-card", onClick: function() {
      showGenericDrawer("Internship X \u2014 Art & Design", "Th\u1EF1c t\u1EADp chuy\u00EAn m\u00F4n t\u1EA1i doanh nghi\u1EC7p \u0111\u1ED1i t\u00E1c MindX\n\n\u2022 Th\u1EF1c h\u00E0nh thi\u1EBFt k\u1EBF cho d\u1EF1 \u00E1n doanh nghi\u1EC7p th\u1EF1c t\u1EBF\n\u2022 Mentor l\u00E0 designer chuy\u00EAn nghi\u1EC7p h\u01B0\u1EDBng d\u1EABn tr\u1EF1c ti\u1EBFp\n\u2022 Cam k\u1EBFt gi\u1EDBi thi\u1EC7u vi\u1EC7c l\u00E0m sau ho\u00E0n th\u00E0nh l\u1ED9 tr\u00ECnh Art\n\nV\u1ECB tr\u00ED: Graphic Designer, UI/UX Designer, Motion Designer",
        "Con thực tập tại studio/agency đối tác MindX — làm việc như designer thật.\n\n\u2726 Làm việc với brief, deadline, feedback từ khách hàng thực tế\n\u2726 Mentor là designer chuyên nghiệp hướng dẫn trực tiếp\n\u2726 Cam kết giới thiệu việc làm: Graphic, Motion, UI/UX, Product Designer\n\nPortfolio thực chiến + kinh nghiệm làm việc thực tế — sẵn sàng ứng tuyển.", "art_internship");
    }});
    ...
    var dhCard = el("div", { className: "tree-card pink", onClick: function() {
      showGenericDrawer("X-Global Art Seed", "Ch\u01B0\u01A1ng tr\u00ECnh \u01B0\u01A1m t\u1EA1o danh m\u1EE5c \u0111\u1EA7u t\u01B0 (Portfolio) & h\u1ED3 s\u01A1 n\u0103ng l\u1EF1c ngh\u1EC7 thu\u1EADt \u0111\u1ED9c quy\u1EC1n t\u1EA1i VN\n\n\u2022 Chuy\u1EC3n h\u00F3a d\u1EF1 \u00E1n c\u00E1 nh\u00E2n th\u00E0nh portfolio ngh\u1EC7 thu\u1EADt chu\u1EA9n qu\u1ED1c t\u1EBF\n\u2022 \u1EE8ng d\u1EE5ng AI (Midjourney/DALL-E) l\u00E0m \u0111\u00F2n b\u1EA9y s\u00E1ng t\u1EA1o\n\u2022 \u0110a ph\u01B0\u01A1ng ti\u1EC7n: Digital Art + Motion + UI/UX + AI-generated content\n\u2022 4 Phase: Product Foundation \u2192 Core Dev \u2192 Global Portfolio \u2192 Demo Day\n\u2022 Th\u1EF1c t\u1EADp chuy\u00EAn m\u00F4n 15 bu\u1ED5i t\u1EA1i ph\u00F2ng ban MindX\n\u2022 Letter of Recommendation + Artist Statement + Gi\u1EA5y ch\u1EE9ng nh\u1EADn s\u1EF1 ki\u1EC7n\n\n\u0110\u1ED1i t\u01B0\u1EE3ng: HS THPT (l\u1EDBp 11-12) \u0111\u00E3 ho\u00E0n th\u00E0nh n\u1EC1n t\u1EA3ng, ho\u1EB7c Sinh vi\u00EAn",
        "Con xây portfolio nghệ thuật quốc tế — hồ sơ du học KHÁC BIỆT.\n\n\u2726 Portfolio đa phương tiện trên Behance + case study chuyên nghiệp\n\u2726 Thực tập chuyên môn tại studio/DN thiết kế\n\u2726 Bộ hồ sơ: Portfolio + LOR + Artist Statement + Internship\n\nCác ngành đích: Visual Communication, Animation, Game Art, UI/UX tại các trường quốc tế.", "art_duhoc");
    }});
